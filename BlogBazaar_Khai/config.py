...
class Config:
    ...
    MAIL_USE_TLS = os.environ.get('MAIL_USE_TLS', 'true').lower() in \
        ['true', 'on', '1']
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME') # Your email that has permission to access Gmail services to send emails
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') # Your app-specific email password obtained from 2-step verification in the account management section
